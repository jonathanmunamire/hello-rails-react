...
Set up a "Hello Rails React" project as one app with Webpack with `jsbundling-rails` gem
...
```sh
  git clone https://github.com/jonathanmunamire/hello-rails-react
  bundle install
  rails s
```
...
Feel free to check the [issues page](https://github.com/jonathanmunamire/hello-rails-react/issues).
